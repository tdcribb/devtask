...
function create_post_type() {
	...
	$args1 = array(
		...
		'public' => true,
		'has_archive' => true,
		'rewrite' => array('slug' => 'impacts'),
		'supports' => array( 'title', 'editor', 'thumbnail', 'price', 'page-attributes' )
	);
	...
	register_post_type( 'impacts', $args1);
	register_post_type( 'reasons', $args2);
	register_post_type( 'testimonials', $args3);


	register_taxonomy_for_object_type('category', 'impacts');
	register_taxonomy_for_object_type('category', 'reasons');
