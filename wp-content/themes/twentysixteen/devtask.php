...
<body>
	<div class="container-fluid">
		...
		<div class="impacts-container conatiner-fluid">
			<div class="row">
		...
		<div class="footer container-fluid">
			...
			<div class="row sm-footer">
				<div class="left-links col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<a href="#" class="footer-link">Calendar</a>
					<a href="#" class="footer-link">Style Guide</a>
				</div>
				<div class="social-links col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="search">
